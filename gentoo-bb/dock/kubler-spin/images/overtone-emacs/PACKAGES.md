### kubler-spin/overtone-emacs:20170423

Built: Sun Nov 12 20:38:08 ART 2017
Image Size: 695MB
...
Package | USE Flags
--------|----------
app-crypt/gnupg-2.2.0 | `bzip2 gnutls smartcard -doc -ldap -nls -readline (-selinux) -tofu -tools -usb -wks-server`
app-crypt/pinentry-1.0.0-r2 | `ncurses -caps -emacs -gnome-keyring -gtk -qt5 -static`
app-editors/emacs-24.5-r3 | `gtk3 inotify ssl xpm zlib -`
...
dev-vcs/git-2.13.6 | `blksha1 curl gpg iconv pcre python threads webdav -cgi -cvs -doc -emacs -gnome-keyring -highlight (-libressl) -mediawiki -mediawiki-experimental -nls -perl (-ppcsha1) -subversion {-test} -tk -xinetd`
net-dns/avahi-0.7 | `dbus introspection -autoipd -bookmarks -doc -gdbm -gtk -gtk3 -howl-compat -ipv6 -mdnsresponder-compat -mono -nls -python -qt4 (-selinux) {-test}`
