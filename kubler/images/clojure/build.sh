...
#
_packages=""
_clojure_version=1.9.0-beta4
#_clojure_version=1.8.0
...
finish_rootfs_build()
{
    ...
    curl -fsSLo "${lein_path}"  https://raw.githubusercontent.com/technomancy/leiningen/2.8.0-RC1/bin/lein
    chmod 755 "${lein_path}"
